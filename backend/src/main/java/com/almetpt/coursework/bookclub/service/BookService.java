...
public class BookService extends GenericService<Book, BookDTO> {
    ...
    public BookService(BookRepository bookRepository, BookMapper bookMapper, AuditService auditService) {
    ...
    public Book createBook(Book book) {
        ...
        auditService.logCreate("BOOK", savedBook.getId(), "Добавлена новая книга: " + savedBook.getTitle());
        return savedBook;
    }
