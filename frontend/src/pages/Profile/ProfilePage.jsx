...
import { getUserInfo, updateUserProfile, getUserOrders, getUserEventApplications, cancelEventApplication, restoreEventApplication } from '../../api/apiClient';
    ...
    <div className="min-h-screen bg-gray-800 p-5 md:p-10 text-white">
      <div className="max-w-6xl mx-auto bg-gray-700 rounded-xl overflow-hidden shadow-2xl">
        <div className="w-full relative overflow-hidden">
          {/* Содержимое шапки */}
          <div className="p-6 md:p-8 border-b border-gray-600">
